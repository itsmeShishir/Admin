...
function Error505() {
  return (
    <>
        <div className="py-5 bg-blue-800 align-center">
            <div className="container">
                {/* Start of the Error Page 500 */}
            ...
            <div className="text-white mt-10 lg:mt-0">
                <div className="intro-x text-8xl font-medium">500</div>
                <div className="intro-x text-xl lg:text-3xl font-medium mt-5">Oops. Bad Request from the server.</div>
